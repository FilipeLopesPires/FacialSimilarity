...
namespace argsParsing {
     ...
     */
    void checkAccess(const char *fileName, std::fstream::ios_base::openmode mode, std::fstream &file);
     ...
     */
    ParsingResult parseArguments(int argc, char **argv, const std::string &HELP, int numOfArgs);
